...
#Возвращает информацию о всех базовых точках на этаже. В случае, если параметр uuid не определён, возвращает все базовые точки со всех этажей
api.add_resource(GetAllBasePointsAtTheFloor, '/base_nodes/get_base_point/<uuid:floor_uuid>', resource_class_kwargs=kwargs_cursor_and_parser)
